...
const seedDB =  async () => {
  ...
  const user1Tweet3Hashtags = await hashtagFinder(user1Tweet3.contents, user1Tweet3.id)
  ...
  const user2Tweet3Hashtags = await hashtagFinder(user2Tweet3.contents, user2Tweet3.id)
  ...
  const user3Tweet3Hashtags = await hashtagFinder(user3Tweet3.contents, user3Tweet3.id)
  ...
  const adminTweet3Hashtags = await hashtagFinder(adminTweet3.contents, adminTweet3.id)
