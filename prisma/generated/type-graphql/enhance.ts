...
const relationResolversInfo = {
  User: ["profile", "tweets", "followedBy", "following"],
  Profile: ["user"],
  Tweet: ["user", "hashtags"],
  Hashtag: ["tweets"]
};
...
const modelsInfo = {
  User: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "email", "password", "name", "username", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCount: ["tweets", "followedBy", "following"],
  UserCountAggregate: ["id", "email", "password", "name", "username", "createdAt", "updatedAt", "_all"],
  UserAvgAggregate: ["id"],
  UserSumAggregate: ["id"],
  UserMinAggregate: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  UserMaxAggregate: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy", "following"],
  UserOrderByWithRelationInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy", "following"],
  UserWhereUniqueInput: ["id", "email", "username"],
  UserOrderByWithAggregationInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  ...
  UserCreateInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy", "following"],
  UserUpdateInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy", "following"],
  UserCreateManyInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  UserUpdateManyMutationInput: ["email", "password", "name", "username", "createdAt", "updatedAt"],
  ...
  UserCountOrderByAggregateInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  UserAvgOrderByAggregateInput: ["id"],
  UserMaxOrderByAggregateInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  UserMinOrderByAggregateInput: ["id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  ...
  UserUpdateManyWithoutFollowedByInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  UserCreateWithoutFollowingInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy"],
  UserCreateOrConnectWithoutFollowingInput: ["where", "create"],
  UserCreateWithoutFollowedByInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "following"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "email", "password", "name", "username", "createdAt", "updatedAt"],
  ...
  UserCreateWithoutProfileInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "tweets", "followedBy", "following"],
  UserCreateOrConnectWithoutProfileInput: ["where", "create"],
  UserUpsertWithoutProfileInput: ["update", "create"],
  UserUpdateWithoutProfileInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "tweets", "followedBy", "following"],
  UserCreateWithoutTweetsInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "followedBy", "following"],
  ...
  UserUpdateWithoutTweetsInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "followedBy", "following"],
  ...
  UserUpdateWithoutFollowingInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "followedBy"],
  UserUpdateWithoutFollowedByInput: ["email", "password", "name", "username", "createdAt", "updatedAt", "profile", "tweets", "following"],
