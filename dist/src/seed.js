...
const seedDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user1Tweet3Hashtags = yield (0, hashtagFinder_1.default)(
    ...
    const user2Tweet3 = yield prisma.tweet.create({
      data: {
        contents:
          "I want to see if these hashtags even work! #testing #flitter",
        userID: user2.id,
        feedItems: {
          create: {
            type: "Tweet",
    ...
    const user2Tweet3Hashtags = yield (0, hashtagFinder_1.default)(
    ...
    const user3Tweet3Hashtags = yield (0, hashtagFinder_1.default)(
      user3Tweet3.contents,
      user3Tweet3.id
    );
    const adminHashedPassword = yield bcryptjs_1.default.hash(
      "adminPassword",
      12
    );
    ...
    const adminTweet3Hashtags = yield (0, hashtagFinder_1.default)(
